...
function createItem() {
  const listItem = [
    ...
    {
      imgUrl: "img/catalog/buckwheat.png",
      title: "Cat Energy PRO",
      mass: "500 г",
      taste: "Гречка",
      price: "400 P.", 
    ...
    {
      imgUrl: "img/catalog/fishBig.png",
      title: "Cat Energy PRO",
      mass: "1000 г",
      taste: "Рыба",
      price: "1000 P.", 
    ...
    {
      imgUrl: "img/catalog/chickenBig.png",
      title: "Cat Energy PRO",
      mass: "1000 г",
      taste: "Курица",
      price: "1000 P.", 
    ...
    {
      imgUrl: "img/catalog/chicken.png",
      title: "Cat Energy PRO",
      mass: "500 г",
      taste: "Курица",
      price: "700 P.", 
